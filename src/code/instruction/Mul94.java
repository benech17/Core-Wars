...
public class Mul94 extends Instruction {

	public Mul94(int a, int b, int c, int d, int e) {
		super(a, b, c, d, e);
	}
	...
	public boolean estValide() {
		if(getAdMode1()==0) {
			...
			throw new RedCodeException("MUL prend un premier argument");
		}
		if(getAdMode2()==0 || getAdMode2()==2) {
			System.out.println(this);
			throw new RedCodeException("MUL prend une adresses en 2 eme arguments");
		}
		if(getType()==7){
			System.out.println(this);
