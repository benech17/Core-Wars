...
public class Sne94 extends Instruction {

	public Sne94(int a, int b, int c, int d, int e) {
		super(a, b, c, d, e);
	}
	...
	public boolean estValide() {
		if(getAdMode1()==0 || getAdMode2()==0)throw new RedCodeException("SNE prend deux arguments");
  	if (getType()>4){
      System.out.println(this);
      throw new RedCodeException("SNE ne peut etre de type F, X ou I");
    }
