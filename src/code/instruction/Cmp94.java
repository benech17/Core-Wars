...
public class Cmp94 extends Instruction {

	public Cmp94(int a, int b, int c, int d, int e) {
		super(a, b, c, d, e);
	}
	...
	public boolean estValide() {
		if(getAdMode1()==0 || getAdMode2()==0)throw new RedCodeException("CMP prend deux arguments");
