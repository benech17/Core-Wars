...
public class Jmz94 extends Instruction {

	public Jmz94(int a, int b, int c, int d, int e) {
		super(a, b, c, d, e);
	}
	...
	public boolean estValide() {
		if(getAdMode1()==0 || getAdMode2()==0)throw new RedCodeException("JMZ prend deux arguments");
		if (getType()>2){
			System.out.println(this);
			throw new RedCodeException("JMZ ne peut etre de type Ab, BA, F, X ou I");
		}
